...
? Integrar las herramientas JS aprendidas hasta aquí
    ...
    * Modifica su estructura anterior, integrando JS con JavaScript 
    * mediante el uso de DOM y Eventos.
    * Programa el circuito de interacción completo de la lógica de tu 
    * aplicación web, agregando las nuevas herramientas JS aprendidas
    * Guarda tus objetos o arrays de objetos en localstorage para dejar 
    * disponible los datos agregados por el usuario ejemplo(los productos en un carrito de compras)
    ! Se debe entregar:
...
? Sugerencias, en esta etapa debes integrar:
    !JavaScript
    * Los algoritmos de JS deben ser invocados desde HTML, 
    * e interactuar con el contenido web, creando HTML, leyendo 
    * y procesando datos ingresados desde formularios, inputs, etc.
    !HTML: 
    * Elimina toda interacción con la Consola JS, convirtiendo 
    *  esta interacción en el DOM del HTML.
    !CSS: 
    * Termina de diseñar la estética visual necesaria en tu webapp 
    * con CSS y/o un framework CSS.
? Criterios de evaluación
    ! Funcionalidad
    * Se simula uno o más flujos de trabajo en términos de entrada, proceso y salida.
    * La funcionalidad es apropiada al contexto del simulador. Carece de errores de cómputo durante el procesamiento.
    ! Interactividad
    ...
    * Se establece un criterio homogéneo para la detección de eventos. Se almacena en storage datos relevantes generados durante la simulación
    !Integridad
...
btnConvertir.addEventListener('click',(e) =>{
    ...
    const inputUnidad = document.getElementById('valorUnidad').value;

    let mensaje = `Hola ${valorUnidad}.`
    
    console.log(inputUnidad);
